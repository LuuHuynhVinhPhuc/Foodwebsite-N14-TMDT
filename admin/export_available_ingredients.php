<?php
    ...
    $dompdf = new Dompdf();
    $sql = "SELECT * FROM food_ingredients WHERE  approved = 'yes'";
        $query = mysqli_query($link, $sql);
        $html ='';
        $html.= '
            <h2 style="text-align: center;">List Available Ingredients</h2>
...
\                    </tr>
    ...
    $dompdf->render();
    $dompdf->stream("ListFoodAvailableIngredient.pdf");
?>
