<?php 
  ...
  $info=[
    "customer"=>"Marcus",
    "invoice_no"=>"0LG01739T3241472T",
    "invoice_date"=>"Nov22,2023",
    "total_amt"=>"200.00",
  ];
  ...
  class PDF extends FPDF
  {
    function Header(){
      ...
      $this->Cell(50,7,"PH : 0123456789",0,1);
    ...
    function body($info,$products_info){
      ...
      $this->SetY(55);
      $this->SetX(60);
      $this->Cell(40,8,"Invoice No: ".$info["invoice_no"]);
      
      //Display Invoice date
      $this->SetY(63);
      $this->SetX(60);
      $this->Cell(40,8,"Invoice Date: ".$info["invoice_date"]);
    ...
    function Footer(){
      ...
      $this->SetY(-50);
      $this->SetFont('Arial','B',12);
      $this->Cell(0,10,"for Maxiccan Burger",0,1,"R");
      $this->Ln(15);
      $this->SetFont('Arial','',12);
